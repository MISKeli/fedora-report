...
import {
  useLazyReportsQuery,
  useReportsQuery,
  useDetailedReportsQuery,
  useLazyDetailedReportsQuery,
} from "../../features/api/fgInventoryApi";
import "../../styles/Pages/FGInventory.scss";

const FG_DROPDOWN_OPTIONS = [
...
const FGInventoryPage = () => {
  ...
  const config = {
    moduleKey: isDetailed ? "DFGInventory" : "FGInventory",
    useQuery: isDetailed ? useDetailedReportsQuery : useReportsQuery,
    useLazyQuery: isDetailed
      ? useLazyDetailedReportsQuery
      : useLazyReportsQuery,
    ...
    searchConfig: {
      ...
      dropdownOptions: FG_DROPDOWN_OPTIONS,
      dropdownLabel: "View",
      dropdownValue: type,
